...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", type=str, default="../data/shapenet", help="dataset path"
    )
    parser.add_argument(
        "--category", type=str, default="Airplane", help="select category"
    )
    parser.add_argument(
        "--npoints", type=int, default=2500, help="resample points number"
    )
    ...
    cmap = np.array(
        [
            ...
            [3.12493437e-02, 1.00000000e00, 1.31250131e-06],
            [0.00000000e00, 6.25019688e-02, 1.00000000e00],
            [1.00000000e00, 0.00000000e00, 9.37500000e-02],
            [1.00000000e00, 0.00000000e00, 9.37500000e-02],
            [1.00000000e00, 0.00000000e00, 9.37500000e-02],
            [1.00000000e00, 0.00000000e00, 9.37500000e-02],
            [1.00000000e00, 0.00000000e00, 9.37500000e-02],
    ...
    dataset = PartNormalDataset(
        root=root, npoints=2048, split="test", normal_channel=False
    )
