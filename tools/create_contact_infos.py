...
from contact_graspnet_pytorch.mesh_utils import (
    in_collision_with_gripper,
    grasp_contact_location,
)
...
def read_object_grasp_data_acronym(root_folder, h5_path):
    ...
    print(
        "positive grasps: {} negative grasps: {}".format(
...
def save_contact_data(pcreader, grasp_path, target_path="mesh_contacts"):
    ...
    contact_dicts = grasps_contact_info(
        output_grasps, list(output_labels), obj_mesh, check_collisions=False
    )
